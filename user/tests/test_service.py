...
class UserServiceTest(TestCase):
    ...
    def test_create_user(self):
        ...
        user, created = user_services.get_or_create_user(
    ...
    def test_get_user_by_sso_id(self):
        user = user_services.get_user_by_sso_id(self.user.sso_email_id)
    ...
    def test_update_user(self):
        ...
        updated_user = user_services.update_user(self.user, **kwargs)
    ...
    def test_update_user_user_error(self):
        ...
        with self.assertRaises(ValueError) as te:
            ...
            user_services.update_user(self.user, **kwargs)
        self.assertEqual(
    ...
    def test_delete_user_errors(self):
        ...
        with self.assertRaises(User.DoesNotExist) as ex:
            user_services.delete_user("9999")
        self.assertEqual(str(ex.exception), "User does not exist")

        # check if user is already deleted
        user_services.delete_user(self.user.sso_email_id)
        with self.assertRaises(UserIsDeleted) as ex:
            user_services.delete_user(self.user.sso_email_id)
