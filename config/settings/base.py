...
# Boto
S3_LOCAL_ENDPOINT_URL = env("S3_LOCAL_ENDPOINT_URL", default=None)
DATA_FLOW_UPLOADS_BUCKET = env("DATA_FLOW_UPLOADS_BUCKET")
DATA_FLOW_UPLOADS_BUCKET_PATH = env("DATA_FLOW_UPLOADS_BUCKET_PATH")
